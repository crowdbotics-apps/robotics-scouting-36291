...
## Project Structure
    ...
    ├── robotics_scouting_36291  # Django project configurations
...
1. Clone this repo and `cd robotics_scouting_36291`
...
2. Clone this repo and `cd robotics_scouting_36291`
